...
import { voucherStatusStyles, whatsappStatusStyles, availabilityStyles } from '../utils/statusStyles';
import { BOOKING_STATUS } from '../data/orders';
import { useOrdersStore } from '../store/useOrdersStore';
import { MessageCircle, IdCard, Phone } from 'lucide-react';
import { Order, BookingStatus } from '../types';
...
export default function TrackingDrawer({ order, onClose, onSendWhatsApp }: TrackingDrawerProps) {
  const updateBookingStatus = useOrdersStore((state) => state.updateBookingStatus);
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <select
            ...
            onChange={(e) => updateBookingStatus(order.id, e.target.value as BookingStatus)}
