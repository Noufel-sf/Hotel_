...
import { availabilityStyles } from '../utils/statusStyles';
import { Hotel, RoomOccupancy, Customer } from '../types';
...
interface BookingFlowModalProps {
  ...
  onClose: () => void;
  onSubmit: (data: BookingSubmissionData) => void;
}

export default function BookingFlowModal({ hotel, searchParams, onClose, onSubmit }: BookingFlowModalProps) {
  const [step, setStep] = useState<'offer' | 'customer'>('offer');
